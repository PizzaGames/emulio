...
import com.github.emulio.scrapers.thegamesdb.clientAutoGenerated.models.Developers
...
class DevelopersAPI(basePath: kotlin.String = "https://api.thegamesdb.net") : ApiClient(basePath) {

    /**
    * Fetch Developers list
    * 
    * @param apikey (Required) 
    * @return kotlin.collections.List<Developers>
    */
    @Suppress("UNCHECKED_CAST")
    fun developers(apikey: kotlin.String) : kotlin.collections.List<Developers> {
        ...
        val response = request<kotlin.collections.List<Developers>>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as kotlin.collections.List<Developers>

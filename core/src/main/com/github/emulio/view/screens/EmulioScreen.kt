...
import com.github.emulio.view.screens.dialogs.*
import com.github.emulio.view.screens.util.ColorCache
import com.github.emulio.view.screens.util.FontCache
...
abstract class EmulioScreen(open val emulio: Emulio) : Screen {
    ...
    fun launchPlatformConfigEditor() {
        ...
        ProcessLauncherService.editFile(platformsFile)
    }

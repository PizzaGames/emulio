...
import com.github.emulio.service.scanner.PlatformScannerService
import com.github.emulio.view.rx.GdxScheduler
import com.github.emulio.view.screens.dialogs.InfoDialog
import com.github.emulio.view.screens.dialogs.YesNoDialog
import com.github.emulio.view.screens.util.FontCache.freeTypeFontGenerator
import com.github.emulio.view.screens.wizard.PlatformWizardScreen
import com.github.emulio.view.theme.ThemeReader
import com.github.emulio.view.util.Subscribe
...
class EmulioSplashScreen(emulio: Emulio) : EmulioScreen(emulio) {
	...
	private fun observePlatforms() {
		val platformsObservable: Observable<List<Platform>> = Observable.create { subscriber ->
			val platforms = PlatformScannerService(emulio).invoke()
